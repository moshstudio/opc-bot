...
export const BaseNode = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "rounded-xl border bg-white dark:bg-slate-900 shadow-sm min-w-[200px] transition-[box-shadow,ring,border-color] duration-200",
          selected
      ...
      >
        ...
        <div className='p-3 space-y-2'>
                  ...
                  return (
                    ...
                    >
                      ...
                      <Handle
                        ...
                        id={cat.key}
                        className={cn(
                          "inner-nodrag w-2.5 h-2.5 border-2 border-white dark:border-slate-950 shadow-sm transition-[transform,opacity] duration-200 z-50",
          ...
          <div className='flex items-center justify-between gap-1.5 mt-2 pt-2 border-t border-slate-100 dark:border-slate-800/50 min-h-[20px]'>
            <div className='flex items-center gap-1.5 flex-1 min-w-0'>
              ...
              {type === "custom_tool" && data.toolName && (
                <span
        ...
        {!isStartType && (
          <Handle
            ...
            className={cn(
              "inner-nodrag w-3 h-3 border-2 border-white dark:border-slate-900 shadow-sm transition-[transform,opacity,background-color] duration-200 hover:scale-125",
            ...
            {type === "condition" ? (
              <>
                <Handle
                  ...
                  id='true'
                  className={cn(
                    "inner-nodrag w-3 h-3 !bg-emerald-500 border-2 border-white dark:border-slate-950 !top-[35%] shadow-sm transition-[transform,opacity] duration-200 hover:scale-125",
                    isHovered || selected
                ...
                <Handle
                  ...
                  id='false'
                  className={cn(
                    "inner-nodrag w-3 h-3 !bg-rose-500 border-2 border-white dark:border-slate-950 !top-[65%] shadow-sm transition-[transform,opacity] duration-200 hover:scale-125",
                    isHovered || selected
                      ? "opacity-100 scale-110"
                      : "opacity-60",
                  )}
              ...
              <Handle
                ...
                position={Position.Right}
                className={cn(
                  "inner-nodrag w-3 h-3 border-2 border-white dark:border-slate-900 shadow-sm transition-[transform,opacity] duration-200 hover:scale-125",
                  isHovered || selected
                    ? "opacity-100 scale-110"
                    : "opacity-40",
                  colors.handleBg,
...
export const MemoizedBaseNode = memo(BaseNode);

export const BaseNodeTypes = Object.fromEntries(
