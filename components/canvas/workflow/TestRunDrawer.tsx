                  ...
                  <ScrollArea className='h-full'>
                    <div className='px-6 pb-6 space-y-6'>
                      <div>
                        ...
                        <div className='bg-slate-950 text-slate-50 p-4 rounded-lg font-mono text-xs overflow-x-auto whitespace-pre-wrap dark:bg-black border border-slate-800 break-words'>
                      ...
                      {result.error && (
                        <div>
                          ...
                          <div className='bg-red-50 dark:bg-red-950/30 text-red-600 dark:text-red-400 p-4 rounded-lg text-sm border border-red-200 dark:border-red-900 break-words'>
                            {result.error}
                          </div>
                        </div>
                      )}
          ...
          <div className='mt-3 pt-3 border-t border-black/5 dark:border-white/5 space-y-3 animate-in fade-in duration-200'>
            ...
            {result.output !== undefined && result.output !== null && (
              <div>
                ...
                <div className='bg-white/50 dark:bg-black/20 rounded p-2 text-xs font-mono overflow-x-auto whitespace-pre-wrap max-h-[200px] overflow-y-auto break-words'>
            ...
            {result.error && (
              <div>
                ...
                <div className='bg-red-100/50 dark:bg-red-950/30 text-red-600 dark:text-red-400 rounded p-2 text-xs font-mono break-words'>
                  {result.error}
                </div>
              </div>
            )}
